...
public:
     ...
     *************************************************************/
    void ReadNoteData(const std::string &strNoteFileName, std::vector<STNOTEDATA> &vectorNoteData);
     ...
     *************************************************************/
    void SaveNoteData(const std::string &strNoteFileName, const STNOTEDATA &noteData, INT32 s32AppendPos = 0);
private:
    void FileData2NoteData(const char *pBuffer, INT32 s32FileSize, std::vector<STNOTEDATA> &listNote);
private:
